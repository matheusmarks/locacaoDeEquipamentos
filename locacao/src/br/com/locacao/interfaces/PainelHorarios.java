	...
	public void eventos(){
		...
		tabela.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				Login.editar_hr.setEnabled(true);
				excluir.setEnabled(true);
		
				DefaultTableModel tmb = (DefaultTableModel) tabela.getModel();
				linha = tabela.getSelectedRow();
				userSelecionada = new Horario();
				userSelecionada.setCod_horario(((int) tabela.getValueAt(linha, 0)));
				userSelecionada.setDiaDaSemana((tabela.getValueAt(linha, 1).toString()));
				userSelecionada.setTempo((tabela.getValueAt(linha, 2).toString()));
		...
		excluir.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
			    ...
			    String sql = "Delete from horarios where cod_horario= "+id+" "; 
...
"" ,JOptionPane.YES_NO_OPTION);
	...
	public static Horario linhaSelecionada(){
